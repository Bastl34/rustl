...
pub const LAYER_SINGLE_VIEW: u32        = 1 << 21;
pub const LAYER_QUAD_VIEW_TOP: u32      = 1 << 22;
pub const LAYER_QUAD_VIEW_FRONT: u32    = 1 << 23;
pub const LAYER_QUAD_VIEW_RIGHT: u32    = 1 << 24;
pub const LAYER_QUAD_VIEW_3D: u32       = 1 << 25;
// bits 26..31 reserved for future internal use
