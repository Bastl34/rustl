...
use super::{node::{NodeItem, Node}, components::{transformation::{Transformation}, alpha::Alpha}};
...
impl Instance
{
    ...
    pub fn get_alpha(&self) -> f32
    {
        ...
        let alpha = Node::get_full_alpha(self.node.clone());

        self.alpha.get_alpha() * alpha
    }
