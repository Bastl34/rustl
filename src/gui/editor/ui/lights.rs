...
pub fn build_light_list(editor_state: &mut EditorState, exec_queue: ExecutionQueueItem, lights: &ChangeTracker<Vec<RefCell<ChangeTracker<LightItem>>>>, ui: &mut Ui, scene_id: u32)
{
